        ...
        try{
            ...
            if($request->hasFile('file')){
                    ...
                    if($getCandidateDocuments->json() != ''){
                        ...
                        for($i=0; $i < $count; $i++){
                            if($getCandidateDocumentType[5]['document_type_id'] == $getCandidateDocuments[$i]['document_title']){
                        ...
                        if($document_id != ''){
                            ...
                            $setCandidateDocuments = Http::asForm()->post($url, [
                                    ...
                                    'document_title' => $getCandidateDocumentType[5]['document_type_id'],
                    ...
                    return redirect()->back()->with('success','Resume is uploaded successfully!');
                    }
                    else{
    ...
    public function printResume()
    {
        try{
            ...
            if($document_path != ''){
                ...
                return back()->with('error','No Resume is available to print');
            }
        }catch(Exception $e){
            echo '<html><head><title>Error 404</title><meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
