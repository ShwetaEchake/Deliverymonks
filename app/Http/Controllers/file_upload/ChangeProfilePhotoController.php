        ...
        try{
            ...
            if($request->hasFile('file')){
                    ...
                    if($getCandidateDocuments->json() != ''){
                        ...
                        for($i=0; $i<$count;$i++){
                            if($getCandidateDocumentType[0]['document_type_id'] == $getCandidateDocuments[$i]['document_title']){
                        ...
                        if($document_id != ''){
                            ...
                            $setCandidateDocuments = Http::asForm()->post($url, [
                                    ...
                                    'document_title' => $getCandidateDocumentType[0]['document_type_id'],
                    ...
                    if($setCandidateDocuments->json() != ''){
                        return redirect()->back()->with('success','Profile Photo is uploaded successfully!');
                    }
                    else{
