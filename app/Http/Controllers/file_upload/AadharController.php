...
class AadharController extends Controller
{
        ...
        try{
            ...
            if($request->hasFile('file')){
                    ...
                    if($getCandidateDocuments->json() != ''){
                        ...
                        for($i=0; $i<$count;$i++){
                            if($getCandidateDocumentType[1]['document_type_id'] == $getCandidateDocuments[$i]['document_title']){
                        ...
                        if($document_id != ''){
                            ...
                            $setCandidateDocuments = Http::asForm()->post($url, [
                                    ...
                                    'document_title' => $getCandidateDocumentType[1]['document_type_id'],
                    ...
                    if($setCandidateDocuments->json() != ''){
                        return redirect()->back()->with('success','Aadhar Card is uploaded successfully!');
                    }
                    else{
                        return redirect()->back()->with('error','Failed to upload Aadhar Card! Please try again');
                    }
    ...
    public function printAadharCard()
    {
        try{
            $url = "http://45.79.124.136/Deliveryboy/API/V1/getDeliveryDetail";
            ...
            if($document_path != ''){
                ...
                return back()->with('error','No Aadhar Card is available to print');
            }
        }catch(Exception $e){
            echo '<html><head><title>Error 404</title><meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
